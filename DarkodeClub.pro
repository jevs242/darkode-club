...
unrealRootPath=/home/jevs/source/repos/tools/UnrealEngine
DarkodeClubRootPath=/home/jevs/source/repos/personal/unreal/darkode-club 4.27

gameProjectFile=/home/jevs/source/repos/personal/unreal/darkode-club 4.27/DarkodeClub.uproject
...
include(DarkodeClubSource.pri)
include(DarkodeClubHeader.pri)
include(DarkodeClubConfig.pri)
include(DarkodeClubIncludes.pri)
include(DarkodeClubDefines.pri)

DarkodeClub-Linux-Debug.commands = $$build DarkodeClub Linux Debug  -project="\"$$gameProjectFile\"" $$args
DarkodeClub-Linux-DebugGame.commands = $$build DarkodeClub Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
DarkodeClub-Linux-Shipping.commands = $$build DarkodeClub Linux Shipping  -project="\"$$gameProjectFile\"" $$args
DarkodeClub-Linux-Test.commands = $$build DarkodeClub Linux Test  -project="\"$$gameProjectFile\"" $$args
DarkodeClub.commands = $$build DarkodeClub Linux Development  -project="\"$$gameProjectFile\"" $$args

DarkodeClubEditor-Linux-Debug.commands = $$build DarkodeClubEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
DarkodeClubEditor-Linux-DebugGame.commands = $$build DarkodeClubEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
DarkodeClubEditor-Linux-Shipping.commands = $$build DarkodeClubEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
DarkodeClubEditor-Linux-Test.commands = $$build DarkodeClubEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
DarkodeClubEditor.commands = $$build DarkodeClubEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	DarkodeClub-Linux-Debug \
	DarkodeClub-Linux-DebugGame \
	DarkodeClub-Linux-Shipping \
	DarkodeClub-Linux-Test \
	DarkodeClub \
	DarkodeClubEditor-Linux-Debug \
	DarkodeClubEditor-Linux-DebugGame \
	DarkodeClubEditor-Linux-Shipping \
	DarkodeClubEditor-Linux-Test \
	DarkodeClubEditor \
